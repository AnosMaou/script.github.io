...
local Themes = {
    ...
    Phoenix = {
		MainFrame = Color3.fromRGB(255, 238, 0),
		Minimise = Color3.fromRGB(255, 191, 0),
		MinimiseAccent = Color3.fromRGB(255, 187, 0),
		Maximise = Color3.fromRGB(255, 179, 0),
		MaximiseAccent = Color3.fromRGB(255, 187, 0),
		NavBar = Color3.fromRGB(255, 213, 0),
		NavBarAccent = Color3.fromRGB(255, 187, 0),
		NavBarInvert = Color3.fromRGB(30,30,30),
		TitleBar = Color3.fromRGB(255, 213, 0),
		TitleBarAccent = Color3.fromRGB(255, 187, 0),
		Overlay = Color3.fromRGB(255, 213, 0),
		Banner = Color3.fromRGB(255,255,255),
		BannerAccent = Color3.fromRGB(255, 187, 0),
		Content = Color3.fromRGB(255, 213, 0),
		Button = Color3.fromRGB(255, 213, 0),
		ButtonAccent = Color3.fromRGB(255, 187, 0),
		ChipSet = Color3.fromRGB(255, 213, 0),
		ChipSetAccent = Color3.fromRGB(255, 187, 0),
		DataTable = Color3.fromRGB(255, 213, 0),
		DataTableAccent = Color3.fromRGB(255, 187, 0),
		Slider = Color3.fromRGB(255, 213, 0),
		SliderAccent = Color3.fromRGB(255, 187, 0),
		Toggle = Color3.fromRGB(255, 213, 0),
		ToggleAccent = Color3.fromRGB(255, 187, 0),
		Dropdown = Color3.fromRGB(255,255,255),
		DropdownAccent = Color3.fromRGB(255, 187, 0),
		ColorPicker = Color3.fromRGB(255,255,255),
		ColorPickerAccent = Color3.fromRGB(255, 187, 0),
		TextField = Color3.fromRGB(255, 213, 0),
		TextFieldAccent = Color3.fromRGB(255,255,255),
	}
}
